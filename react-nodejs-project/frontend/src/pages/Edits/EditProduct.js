        ...
        .map(
          (proAdd) =>
            additionalFeatures.find(
              (feature) => feature.UrunAdi === proAdd.additional_feature
            )?.ID
        )
        .filter((id) => id); // Geçerli ID'leri al
                  ...
                  {variants.map((variant) => (
                    <label key={variant.ID}>
                      <input
                        ...
                        checked={editingProduct?.variants_id?.includes(
                          variant.ID
                        )}
                      />
                      {variant.UrunAdi}
                  ...
                  {additionalFeatures.map((feature) => (
                    <label key={feature.ID}>
                      <input
                        ...
                        checked={editingProduct?.additionalfeatures_id?.includes(
                          feature.ID
                        )}
                      />
                      {feature.UrunAdi}
